...
public class EnemyDinoSpawner : MonoBehaviour
{
    ...
    public void StartSpawn()
    {
        ...
        GameObject SpawnObject = dinos[dinoIndex];
        dinoIndex = (dinoIndex + 1) % numDinos;
        ...
        for (int j = 0; j < MaxIterations; j++)
        {
            ...
            Quaternion spawnRotation = Quaternion.FromToRotation(Vector3.down, spawnNormal);
            if (prefabBounds.HasValue)
            {
